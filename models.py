...
def CNN44():
    return ResNetNN(
        block_type=ConvBlock, num_blocks=[7, 7, 7], option="A", ResNet=False
    )


def CNN32():
    return ResNetNN(
        block_type=ConvBlock, num_blocks=[5, 5, 5], option="A", ResNet=False
    )


def CNN20():
    return ResNetNN(
        block_type=ConvBlock, num_blocks=[3, 3, 3], option="A", ResNet=False
    )
...
def CNN8():
    return ResNetNN(
        block_type=ConvBlock, num_blocks=[1, 1, 1], option="A", ResNet=False
    )


def CNN14():
    return ResNetNN(
        block_type=ConvBlock, num_blocks=[2, 2, 2], option="A", ResNet=False
    )
